...
export interface JSBSimBuildIdentity {
  ...
  readonly sdk: { readonly commit: string; readonly contentSha256: string; readonly dirty: boolean };
  readonly build: {
...
export const buildIdentity: JSBSimBuildIdentity = (() => {
  throw new Error("SDK build identity requires the resolved build pipeline; run npm run build or build:local and consume its package.");
})();
